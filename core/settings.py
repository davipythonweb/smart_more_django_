...
# usando variaveis de ambient com python-dotenv
...
# CONFIGURAÇAO PARA OS HOSTS NA PROGRAMAÇAO EM NUVEM
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], # carregar templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
